...
import VideoGaris from "./videoGaris";
...
export const RewardSystemCard = () => {
  ...
  return (
    <div className="mt-20 rewardSystemCard relative w-full sm:pt-[72px] px-6 pb-6">
      <div className="bg-line absolute z-0 top-0 bottom-0 left-0 right-0">
        <VideoGaris />
      </div>
      ...
      <div className="relative">
        ...
        {/* percentage overlay */}
        <h3 className="grayTextGradient text-[48px] sm:text-[64px] lg:text-[72px] text-center z-[2] absolute top-[120px] xs:top-[152px] sm:top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
